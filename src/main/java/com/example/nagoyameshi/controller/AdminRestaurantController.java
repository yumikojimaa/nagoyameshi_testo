...
public class AdminRestaurantController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        RestaurantEditForm restaurantEditForm = new RestaurantEditForm(restaurant.getId(), restaurant.getName(), null, restaurant.getDescription(), restaurant.getLowestPrice(), restaurant.getHighestPrice(), restaurant.getPostalCode(), restaurant.getAddress(), restaurant.getRegularHoliday(), imageName, restaurant.getSeatingCapacity(), restaurant.getCategory().getId());
